app.controller('logincontroller', ['loginservice','DashboardService' ,'$scope', '$location', '$rootScope', '$cookieStore', function (loginservice,DashboardService, $scope, $location, $rootScope, $cookieStore) {
